...
MenuIterator main_select_module_do( Move_flag, MenuIterator, IO_Potentiometer[SPI_POTAR_COUNT] );
...
MenuIterator selmod_change_bank_do( Move_flag, MenuIterator, IO_Potentiometer[SPI_POTAR_COUNT] );

/**
 * Add new Bank
 */
void selmod_add_bank_enter();
MenuIterator selmod_add_bank_do( Move_flag, MenuIterator, IO_Potentiometer[SPI_POTAR_COUNT] );

/**
 * Edit Current Bank
 */
void selmod_edit_bank_enter();
MenuIterator selmod_edit_bank_do( Move_flag, MenuIterator, IO_Potentiometer[SPI_POTAR_COUNT] );
...
MenuIterator selmod_editb_selpar_do( Move_flag, MenuIterator, IO_Potentiometer[SPI_POTAR_COUNT] );

/**
 * Modify Choosen Param
 */
void selmod_editb_editpar_enter();
MenuIterator selmod_editb_editpar_do( Move_flag, MenuIterator, IO_Potentiometer[SPI_POTAR_COUNT] );
