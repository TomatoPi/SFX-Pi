...
MenuIterator main_add_module_do( Move_flag action, MenuIterator itr, IO_Potentiometer pot[SPI_POTAR_COUNT] ){
...
MenuIterator addmod_choose_type_do( Move_flag action, MenuIterator itr, IO_Potentiometer pot[SPI_POTAR_COUNT] ){
