...
namespace {
    ...
    const string REDIR = "IOS::Redirection : ";
}

void IOS::init_screen(){
    ...
    IOS::printm( PROG_SPLASH_SCREEN , IOS::OVERIDE);
    IOS::printm( string("Hy Tomato"), 3000, IOS::TEMP );
    IOS::printm( PROG_RUN, IOS::SEG7 );
}
