 ...
 * function call.
 * *****************************************************************/
mcp23017::mcp23017(unsigned char dev_addr, std::string i2c_file_name){
 ...
 ********************************************************************/
int mcp23017::writeReg(unsigned char reg_addr, unsigned char data){
 ...
 *variable "data".
 ********************************************************************/
int mcp23017::readReg(unsigned char reg_addr, unsigned char &data){
