...
class JACKUnit{
    ...
    public :
         ...
         **/
        static const char* portTypeString(SFXP::PortType t);
         ...
         **/
        void registerPorts(const std::string** names,const SFXP::usize_t* count, SFXP::id1_t id);
        ...
        jack_port_t*   getPort(SFXP::PortType type, SFXP::usize_t idx);

        SFXP::usize_t getPortCount(SFXP::PortType type);
