...
#include "plugin/PluginConfigLoader.h"
#include "plugin/PluginSourceLoader.h"
...
namespace PluginLoader {
     ...
     **/
    JackPlugin* loadPlugin(std::string path);
...
class EffectFactory{
    ...
    public :
        ...
        typedef std::map<SFXP::tc_t,JackPlugin*> EffectFactoryRegistry;
         ...
         **/
        static JackPlugin* getPlugin(SFXP::tc_t tc);
