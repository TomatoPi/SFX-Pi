...
template<> const size_t ChorusReg::PARCOUNT = 14;

template<> const std::string ChorusReg::PORNAMES[] = {"Input","Mod","Output"};

template<> const size_t ChorusReg::AI = 2;
template<> const size_t ChorusReg::AO = 1;
template<> const size_t ChorusReg::MI = 0;
template<> const size_t ChorusReg::MO = 0;

template<> const size_t ChorusReg::PARSIZE = ChorusReg::PARCOUNT + 5;
