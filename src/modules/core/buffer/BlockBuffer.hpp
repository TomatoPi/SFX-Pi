 ...
 **/
template <typename Data, size_t S, size_t N> BlockBuffer<Data,S,N>::BlockBuffer():
...
void BlockBuffer<Data,S,N>::write( Data const *block, size_t size ){
 ...
 **/
template <typename Data, size_t S, size_t N>
Data* BlockBuffer<Data,S,N>::get( size_t r ){
/*
