...
/* ************************** Constructor *************************** */
/* ****************************************************************** */
AbstractEffectUnit::AbstractEffectUnit(uint8_t id, uint8_t type, size_t bankSize, size_t paramSize):
    m_id( id ),
    m_type( type ),
    m_jackU( NULL ),
...
/* ************************* Bank Managment ************************* */
/* ****************************************************************** */
void AbstractEffectUnit::addBank(uint8_t id, size_t size, const float *values){
