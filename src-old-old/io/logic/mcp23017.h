...
class mcp23017
{
    ...
    public :
        ...
        mcp23017(hex_t dev_addr, std::string i2cfilename);
        //over loaded constructor
        ~mcp23017(void); // destructor
        int writeReg(hex_t reg_addr, hex_t data);
                // function to write byte data into a register of an I2C device
        int writeReg(hex_t reg_addr, hex_t mask, hex_t data);
                // function to write data into a register masking unused values
        int readReg(hex_t reg_addr, hex_t &data);
    ...
    private :
        ...
        hex_t deviceAddress; // i2c device address
};
