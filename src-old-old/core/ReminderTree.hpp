 ...
 **/
template <typename Val, usize_t Depth>
Val ReminderTree<Val,Depth>::remove( Val seq[Depth], usize_t depth ){
 ...
 **/
template <typename Val, usize_t Depth>
void ReminderTree<Val,Depth>::printNode( Node<Val> *node, usize_t d ) const{
