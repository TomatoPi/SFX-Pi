 ...
 *       -2
 **/
template <typename Val, usize_t Depth>
class ReminderTree{
    ...
    public :
         ...
         **/
        Val remove( Val seq[Depth], usize_t depth=(Depth-1) );
    ...
    private :
         ...
         **/
        void printNode( Node<Val> *node, usize_t d ) const;
         ...
         **/
        std::vector<Val*> getNode( Node<Val> *node, std::vector<Val*> out, Val prefix[Depth], usize_t depth ) const;
