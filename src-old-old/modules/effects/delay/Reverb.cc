...
template<> const usize_t ReverbReg::PARCOUNT = 5;
...
template<> const usize_t ReverbReg::AI = 1;
template<> const usize_t ReverbReg::AO = 2;
template<> const usize_t ReverbReg::MI = 0;
template<> const usize_t ReverbReg::MO = 0;

template<> const usize_t ReverbReg::PARSIZE = ReverbReg::PARCOUNT
...
void ReverbEffect::update(){
    ...
    // Fill delays bins
    for ( usize_t i = 0; i < LINE_COUNT; i++){
