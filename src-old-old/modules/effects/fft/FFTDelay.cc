...
template<> const usize_t FFTDelayReg::PARCOUNT = 4;

template<> const std::string FFTDelayReg::PORNAMES[] = {
    "Input", "Output"};

template<> const usize_t FFTDelayReg::AI = 1;
template<> const usize_t FFTDelayReg::AO = 1;
template<> const usize_t FFTDelayReg::MI = 0;
template<> const usize_t FFTDelayReg::MO = 0;

template<> const usize_t FFTDelayReg::PARSIZE = FFTDelay::BIN/2 + 2;
/* ***************************** FFTDelay *************************** */
